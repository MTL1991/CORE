...
exports.search = function(req, res, next) {
      ...
      searchValue = "%" + search.replace(/ +/g, "%") + "%";

      models.Post
        .findAll({order: 'updatedAt DESC',
                  
                  where: ["title like ? OR body like?", searchValue, searchValue],
        })
        .success(function(posts) {
                  res.render('posts/search', {
                    posts: posts,
                    search: search //Variable  que rellena el formulario. Si es indefinido lo deja en blanco
                  });
        })
        .error(function(error) {
